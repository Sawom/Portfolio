        ...
        <div>
          <div className="card cardStyle bg-base-100 shadow-2xl">
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <a
                  href="https://sawom.github.io/G3-Architects-ph/"
                  target="_blank"
                >
                  <button className="btn btn-outline btn-sm border-4 mt-6">
                    <span className="flex px-2">
        ...
        <div>
          <div className="card cardStyle bg-base-100 shadow-2xl">
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <a
                  href="https://sawom.github.io/Biker-Zone-ph/"
                  target="_blank"
                >
                  <button className="btn btn-outline btn-sm border-4 mt-6">
                    <span className="flex px-2">
            ...
            <figure>
              <div className="carousel w-full">
                ...
                <div id="slide24" className="carousel-item relative w-full">
                  ...
                  <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide26" className="btn btn-circle">
                      ❮
                    </a>
                    <a href="#slide25" className="btn btn-circle">
                      ❯
                    </a>
                  </div>
                </div>
                ...
                <div id="slide25" className="carousel-item relative w-full">
                  ...
                  <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide24" className="btn btn-circle">
                      ❮
                    </a>
                    <a href="#slide26" className="btn btn-circle">
                      ❯
        ...
        <div>
          <div className="card cardStyle bg-base-100 shadow-2xl">
            ...
            <figure>
              <div className="carousel w-full">
                ...
                <div id="slide34" className="carousel-item relative w-full">
                  ...
                  <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide36" className="btn btn-circle">
                      ❮
                    </a>
                    <a href="#slide35" className="btn btn-circle">
                      ❯
                    </a>
                  </div>
                </div>
                ...
                <div id="slide35" className="carousel-item relative w-full">
                  ...
                  <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide34" className="btn btn-circle">
                      ❮
                    </a>
                    <a href="#slide36" className="btn btn-circle">
                      ❯
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <a
                  href="https://sawom.github.io/Business-Agency-ph/"
                  target="_blank"
                >
                  <button className="btn btn-outline btn-sm border-4 mt-6">
                    <span className="flex px-2">
        ...
        <div>
          <div className="card cardStyle bg-base-100 shadow-2xl">
            ...
            <figure>
              <div className="carousel w-full">
                ...
                <div id="slide44" className="carousel-item relative w-full">
                  ...
                  <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide46" className="btn btn-circle">
                      ❮
                    </a>
                    <a href="#slide45" className="btn btn-circle">
                      ❯
                    </a>
                  </div>
                </div>
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <a
                  href="https://sawom.github.io/WDPr8-Honda-Bazar/index.html"
                  target="_blank"
                >
                  <button className="btn btn-outline btn-sm border-4 mt-6">
                    <span className="flex px-2">
            ...
            <figure>
              <div className="carousel w-full">
                ...
                <div id="slide55" className="carousel-item relative w-full">
                  ...
                  <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                    <a href="#slide54" className="btn btn-circle">
                      ❮
                    </a>
                    <a href="#slide54" className="btn btn-circle">
                      ❯
